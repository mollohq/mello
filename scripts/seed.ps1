...
Write-Host ""
Write-Host "  Crew feed / clips:" -ForegroundColor Yellow
Write-Host "    Gamers:  3 clips, 2 voice sessions, 1 game session,"
Write-Host "             2 moments, 1 weekly recap"
Write-Host "    Devs:    2 clips, 1 stream session, 1 voice session,"
Write-Host "             1 member joined"
Write-Host "    Music:   2 clips (FOMO badge on sidebar)"
Write-Host ""
Write-Host "  Card types exercised:" -ForegroundColor Yellow
Write-Host "    clip     - hero (newest) + standard + older"
Write-Host "    session  - voice, stream, game"
Write-Host "    recap    - weekly summary with stats"
Write-Host "    catchup  - moments with game context"
Write-Host ""
