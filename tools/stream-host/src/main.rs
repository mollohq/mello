...
fn run_sfu_mode(
    ...
    while RUNNING.load(Ordering::Relaxed) {
        ...
        let stats_now = conn
            ...
            .unwrap_or_else(|_| unsafe { std::mem::zeroed() });
        log::info!(
            "host_probe_tick session={} wall_ms={} mono_ms={} viewers={} video_open={} control_open={} rtt_ms={:.1} disconnect={} tx_aus_sent={} tx_aus_dropped={} tx_rtp_packets={} tx_rtp_bytes={} tx_queue_peak={} tx_pacing_target_kbps={} tx_gcc_target_kbps={} tx_pacing_delay_us={} tx_fec_packets={} tx_rtx_sent={} tx_pli={} tx_remb={}",
            session_id,
            wall_ms,
            mono_ms,
            joined_viewers,
